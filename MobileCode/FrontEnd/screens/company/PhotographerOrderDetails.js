...
function PhotographerOrderDetails({route}) {
  ...
  return (
    ...
    showsVerticalScrollIndicator={false}   contentContainerStyle={{  backgroundColor: COLORS.white,}} >
      ...
      <View>
        ...
        <Text style={{color:COLORS.primary, fontSize:30,fontWeight:'bold',paddingLeft:12, marginBottom: 20}}>Photographer Order Details</Text>
                    ...
                    <View style={style.rightTag}>
                      ...
                      <View style={style.priceTag}> 
                      <Text style={style.leftTag}>{sub_order.session_time} </Text>
                    </View>
                    </View>
                    ...
                    <View style={style.rightTag}>
                      ...
                      <View style={style.priceTag}> 
                      <Text style={style.leftTag}>{sub_order.shoot_type} </Text>
                    </View>
                    </View> 
...
export default PhotographerOrderDetails;
